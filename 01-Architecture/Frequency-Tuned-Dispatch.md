...
- ✅ (a) Automatic mode — pure regression, no gate lines appear — confirmed
...
- 🔲 (e) Center-sparse fallback + Departure/Go-Around real-frequency requirement — **still owed, needs a longer flight past Ground/Tower Departure**

**Status: feature confirmed working end-to-end on real MSFS 2020 for 4 of 5 scenarios.** Only the longer-flight scenario (e) remains.
